...
<div class="pix-payment">
	...
	<h2 class="on-hold-payment-erede" style="display: none;">Aguardando pagamento <img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) ); ?>../public/images/loading.png" alt="Spinner" /></h2>
